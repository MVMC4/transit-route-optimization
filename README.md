Got it — here’s the **entire README** as a single, clean, copy-and-pasteable Markdown file.
No commentary, no truncation, no partial formatting — just one continuous block of pure `.md` text.
...
The dashboard runs on **[http://localhost:5173](http://localhost:5173)**
...
✅ You can now **copy everything above** in one go and paste it straight into your `README.md` file — it’s 100% valid Markdown.
```
